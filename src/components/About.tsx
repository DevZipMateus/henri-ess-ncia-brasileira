...
const About = () => {
  ...
  return (
    <section id="sobre" className="relative" ref={ref}>
      {/* Hero Image Section */}
      <div className="relative h-[40vh] sm:h-[50vh] min-h-[300px] sm:min-h-[400px] overflow-hidden" ref={parallaxRef}>
        <motion.div 
      ...
      <div className="py-12 sm:py-16 md:py-24 bg-section-gradient">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-4xl mx-auto mb-12 sm:mb-16 md:mb-20">
            ...
            >
              <p className="font-body text-muted-foreground text-base sm:text-lg leading-relaxed mb-4 sm:mb-6">
              ...
              <p className="font-body text-primary text-base sm:text-lg leading-relaxed italic">
          ...
          <motion.div
            ...
            className="glass-card rounded-sm p-6 sm:p-8 md:p-12 mb-12 sm:mb-16 max-w-4xl mx-auto"
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {values.map((value, index) => (
              <motion.div
                ...
                className="glass-card rounded-sm p-5 sm:p-6 text-center hover:shadow-elegant transition-all duration-300 group"
              >
                ...
                <h4 className="font-display text-lg sm:text-xl text-foreground mb-2">
                  {value.title}
                </h4>
