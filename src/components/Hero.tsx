        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            <img
              ...
              className="w-72 sm:w-96 md:w-[28rem] lg:w-[34rem] h-auto drop-shadow-lg"
            />
          </motion.div>
          ...
          <motion.h2
            ...
            className="font-display text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white/90 italic mb-3 sm:mb-4 px-2"
          >
